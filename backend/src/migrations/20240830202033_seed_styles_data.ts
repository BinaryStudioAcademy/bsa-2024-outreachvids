...
async function up(knex: Knex): Promise<void> {
    await knex(TABLE_NAME).insert([
        ...
        { id: 'bbfb571d-b4d7-4fed-a867-c9c3d9a282e8', style: 'graceful-sitting' },
        { id: '6af1591c-941d-4d89-86c7-2ac354e20620', style: 'graceful-standing' },
        { id: '856235f0-e3a3-46da-8814-dc0716b04724', style: 'technical-sitting' },
        { id: '254aa1e9-7651-46cd-8a5e-71588020804e', style: 'technical-standing' },
