...
import { createVideoValidationSchema, updateVideoValidationSchema, } from './validation-schemas/validation-schemas.js';
/**
 * @swagger
 * components:
 *    schemas:
...
class VideoController extends BaseController {
    ...
    constructor(logger, videoService) {
        ...
        this.addRoute({
            ...
            handler: (options) => this.update(options),
        });
        this.addRoute({
            path: VideosApiPath.ID,
            method: 'DELETE',
    ...
    async update(options) {
        return {
            status: HttpCode.OK,
            payload: await this.videoService.update(options.params.id, options.body),
        };
    }
    /**
     * @swagger
